 ...
 *
 * Do not name the private package here. This file is copied verbatim into the
 * CLI's public snapshot by scripts/sync-cli-public-api-client.mjs, and the
 * public-repo audit fails on any private-scope marker — so a mention here
 * blocks every public sync. Fixed once in 8585cd8bf, then reintroduced by a
 * regeneration that overwrote the downstream copy instead of this source.
 *
